...
typedef enum
{
    ...
    GERIUM_SCANCODE_8            = 8,
    GERIUM_SCANCODE_9            = 9,
    GERIUM_SCANCODE_A            = 10,
    GERIUM_SCANCODE_B            = 11,
    GERIUM_SCANCODE_C            = 12,
    GERIUM_SCANCODE_D            = 13,
    GERIUM_SCANCODE_E            = 14,
    GERIUM_SCANCODE_F            = 15,
    GERIUM_SCANCODE_G            = 16,
    GERIUM_SCANCODE_H            = 17,
    GERIUM_SCANCODE_I            = 18,
    GERIUM_SCANCODE_J            = 19,
    GERIUM_SCANCODE_K            = 20,
    GERIUM_SCANCODE_L            = 21,
    GERIUM_SCANCODE_M            = 22,
    GERIUM_SCANCODE_N            = 23,
    GERIUM_SCANCODE_O            = 24,
    GERIUM_SCANCODE_P            = 25,
    GERIUM_SCANCODE_Q            = 26,
    GERIUM_SCANCODE_R            = 27,
    GERIUM_SCANCODE_S            = 28,
    GERIUM_SCANCODE_T            = 29,
    GERIUM_SCANCODE_U            = 30,
    GERIUM_SCANCODE_V            = 31,
    GERIUM_SCANCODE_W            = 32,
    GERIUM_SCANCODE_X            = 33,
    GERIUM_SCANCODE_Y            = 34,
    GERIUM_SCANCODE_Z            = 35,
    GERIUM_SCANCODE_F1           = 36,
    GERIUM_SCANCODE_F2           = 37,
    GERIUM_SCANCODE_F3           = 38,
    GERIUM_SCANCODE_F4           = 39,
    GERIUM_SCANCODE_F5           = 40,
    GERIUM_SCANCODE_F6           = 41,
    GERIUM_SCANCODE_F7           = 42,
    GERIUM_SCANCODE_F8           = 43,
    GERIUM_SCANCODE_F9           = 44,
    GERIUM_SCANCODE_F10          = 45,
    GERIUM_SCANCODE_F11          = 46,
    GERIUM_SCANCODE_F12          = 47,
    GERIUM_SCANCODE_F13          = 48,
    GERIUM_SCANCODE_F14          = 49,
    GERIUM_SCANCODE_F15          = 50,
    GERIUM_SCANCODE_CALCULATOR   = 51,
    GERIUM_SCANCODE_NUMPAD0      = 52,
    GERIUM_SCANCODE_NUMPAD1      = 53,
    GERIUM_SCANCODE_NUMPAD2      = 54,
    GERIUM_SCANCODE_NUMPAD3      = 55,
    GERIUM_SCANCODE_NUMPAD4      = 56,
    GERIUM_SCANCODE_NUMPAD5      = 57,
    GERIUM_SCANCODE_NUMPAD6      = 58,
    GERIUM_SCANCODE_NUMPAD7      = 59,
    GERIUM_SCANCODE_NUMPAD8      = 60,
    GERIUM_SCANCODE_NUMPAD9      = 61,
    GERIUM_SCANCODE_NUMLOCK      = 62,
    GERIUM_SCANCODE_NUMPADCOMMA  = 63,
    GERIUM_SCANCODE_NUMPADENTER  = 64,
    GERIUM_SCANCODE_NUMPADEQUALS = 65,
    GERIUM_SCANCODE_NUMPADMINUS  = 66,
    GERIUM_SCANCODE_NUMPADPERIOD = 67,
    GERIUM_SCANCODE_NUMPADPLUS   = 68,
    GERIUM_SCANCODE_NUMPADSLASH  = 69,
    GERIUM_SCANCODE_NUMPADSTAR   = 70,
    GERIUM_SCANCODE_PLAYPAUSE    = 71,
    GERIUM_SCANCODE_PREVTRACK    = 72,
    GERIUM_SCANCODE_NEXTTRACK    = 73,
    GERIUM_SCANCODE_MUTE         = 74,
    GERIUM_SCANCODE_VOLUMEDOWN   = 75,
    GERIUM_SCANCODE_VOLUMEUP     = 76,
    GERIUM_SCANCODE_MEDIASELECT  = 77,
    GERIUM_SCANCODE_MEDIASTOP    = 78,
    GERIUM_SCANCODE_ESCAPE       = 79,
    GERIUM_SCANCODE_TAB          = 80,
    GERIUM_SCANCODE_CAPSLOCK     = 81,
    GERIUM_SCANCODE_RETURN       = 82,
    GERIUM_SCANCODE_BACKSLASH    = 83,
    GERIUM_SCANCODE_BACKSPACE    = 84,
    GERIUM_SCANCODE_MINUS        = 85,
    GERIUM_SCANCODE_COLON        = 86,
    GERIUM_SCANCODE_COMMA        = 87,
    GERIUM_SCANCODE_CONVERT      = 88,
    GERIUM_SCANCODE_NOCONVERT    = 89,
    GERIUM_SCANCODE_EQUALS       = 90,
    GERIUM_SCANCODE_GRAVE        = 91,
    GERIUM_SCANCODE_PERIOD       = 92,
    GERIUM_SCANCODE_POWER        = 93,
    GERIUM_SCANCODE_SEMICOLON    = 94,
    GERIUM_SCANCODE_SLASH        = 95,
    GERIUM_SCANCODE_SLEEP        = 96,
    GERIUM_SCANCODE_SPACE        = 97,
    GERIUM_SCANCODE_STOP         = 98,
    GERIUM_SCANCODE_SYSRQ        = 99,
    GERIUM_SCANCODE_UNDERLINE    = 100,
    GERIUM_SCANCODE_UNLABELED    = 101,
    GERIUM_SCANCODE_APOSTROPHE   = 102,
    GERIUM_SCANCODE_WAKE         = 103,
    GERIUM_SCANCODE_LALT         = 104,
    GERIUM_SCANCODE_RALT         = 105,
    GERIUM_SCANCODE_LBRACKET     = 106,
    GERIUM_SCANCODE_RBRACKET     = 107,
    GERIUM_SCANCODE_LCONTROL     = 108,
    GERIUM_SCANCODE_RCONTROL     = 109,
    GERIUM_SCANCODE_LSHIFT       = 110,
    GERIUM_SCANCODE_RSHIFT       = 111,
    GERIUM_SCANCODE_LWIN         = 112,
    GERIUM_SCANCODE_RWIN         = 113,
    GERIUM_SCANCODE_UPARROW      = 114,
    GERIUM_SCANCODE_LEFTARROW    = 115,
    GERIUM_SCANCODE_RIGHTARROW   = 116,
    GERIUM_SCANCODE_DOWNARROW    = 117,
    GERIUM_SCANCODE_SCROLL       = 118,
    GERIUM_SCANCODE_PAUSE        = 119,
    GERIUM_SCANCODE_INSERT       = 120,
    GERIUM_SCANCODE_DELETE       = 121,
    GERIUM_SCANCODE_HOME         = 122,
    GERIUM_SCANCODE_END          = 123,
    GERIUM_SCANCODE_PGUP         = 124,
    GERIUM_SCANCODE_PGDN         = 125,
    GERIUM_SCANCODE_MAIL         = 126,
    GERIUM_SCANCODE_MYCOMPUTER   = 127,
    GERIUM_SCANCODE_APPS         = 128,
    GERIUM_SCANCODE_ABNT_C1      = 129,
    GERIUM_SCANCODE_ABNT_C2      = 130,
    GERIUM_SCANCODE_AT           = 131,
    GERIUM_SCANCODE_AX           = 132,
    GERIUM_SCANCODE_KANA         = 133,
    GERIUM_SCANCODE_KANJI        = 134,
    GERIUM_SCANCODE_OEM_102      = 135,
    GERIUM_SCANCODE_WEBBACK      = 136,
    GERIUM_SCANCODE_WEBFAVORITES = 137,
    GERIUM_SCANCODE_WEBFORWARD   = 138,
    GERIUM_SCANCODE_WEBHOME      = 139,
    GERIUM_SCANCODE_WEBREFRESH   = 140,
    GERIUM_SCANCODE_WEBSEARCH    = 141,
    GERIUM_SCANCODE_WEBSTOP      = 142,
    GERIUM_SCANCODE_YEN          = 143,
