...
void check(VkResult result) {
    switch (result) {
        ...
        case VK_ERROR_INITIALIZATION_FAILED:
            throw Exception(GERIUM_RESULT_ERROR_DEVICE_SELECTION);
        case VK_ERROR_DEVICE_LOST:
            throw Exception(GERIUM_RESULT_ERROR_DEVICE_LOST);
        case VK_ERROR_MEMORY_MAP_FAILED:
            throw Exception(GERIUM_RESULT_ERROR_INVALID_OPERATION);
        case VK_ERROR_LAYER_NOT_PRESENT:
            throw Exception(GERIUM_RESULT_ERROR_NOT_FOUND);
        ...
        case VK_ERROR_FORMAT_NOT_SUPPORTED:
            throw Exception(GERIUM_RESULT_ERROR_FORMAT_NOT_SUPPORTED);
        case VK_ERROR_FRAGMENTED_POOL:
            throw Exception(GERIUM_RESULT_ERROR_OUT_OF_MEMORY);
        case VK_ERROR_UNKNOWN:
            throw Exception(GERIUM_RESULT_ERROR_UNKNOWN);
        case VK_ERROR_INVALID_EXTERNAL_HANDLE:
            throw Exception(GERIUM_RESULT_ERROR_INVALID_RESOURCE);
        ...
        case VK_ERROR_INCOMPATIBLE_DISPLAY_KHR:
            throw Exception(GERIUM_RESULT_ERROR_NO_DISPLAY);
        case VK_ERROR_VALIDATION_FAILED_EXT:
            throw Exception(GERIUM_RESULT_ERROR_INVALID_OPERATION);
        case VK_ERROR_INVALID_SHADER_NV:
            throw Exception(GERIUM_RESULT_ERROR_COMPILE_SHADER);
