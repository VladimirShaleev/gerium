...
#define FROXEL_GRID_SIZE_X 240
#define FROXEL_GRID_SIZE_Y 140
#define FROXEL_GRID_SIZE_Z 256
#define FROXEL_LOCAL_X 8
#define FROXEL_LOCAL_Y 8
#define FROXEL_LOCAL_Z 1
