...
void Application::frame(gerium_uint64_t elapsedMs) {
    ...
    gerium_frame_graph_enable_node(_frameGraph, "volumetric_inject_pass", !debugMeshlets);
    gerium_frame_graph_enable_node(_frameGraph, "light_integration_pass", !debugMeshlets);
    gerium_frame_graph_enable_node(_frameGraph, "ssao_pass", !debugMeshlets);
